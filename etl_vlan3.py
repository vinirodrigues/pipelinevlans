...
# Caminho do arquivo
caminho_arquivo = "C:\\Users\\vinicius\\Desktop\\ETL_VLANS\\interfaces.txt"
...
for bloco in blocos:
    ...
    if vlan_match and description_match and len(destinations) >= 1:
        ...
        destination1 = destinations[-2] if len(destinations) >= 2 else destinations[-1]
